...
default_punctation = list(punctuation) + ['…', '”', '“', '...', '..']

stopwords = ['de', 'a', 'o', 'ô', 'que', 'e', 'do', 'da', 'em', 'um', 'para',
             ...
             'estou', 'pra', 'está', 'estamos', 'estão', 'estive', 'esteve',
             ...
             'teremos', 'terão', 'teria', 'teríamos', 'teriam', 'vou', 'vamos',
             'vais', 'aqui', 'lá', 'tão', 'vai', 'nada', 'mim', 'tudo', 'faz',
             'ver', 'então', 'todo', 'posso', 'pode', 'sei', 'diz', 'dizer',
             'sempre', 'nunca', 'todos', 'dia', 'noite', 'quero', 'tanto',
             'quanto']
